      ...
      <div class="card-body" style="padding-top:0px;">
        ...
        [@b.form action="!save" theme="list" name="activityForm"]
          ...
          [@b.textfield label="艺术辅导老师1" name="coach1.name" id="coach1_name" value=(activity.coach1.name)!
                        onchange="searchUser(this,'coach1_id');" style="width:200px" placeholder="输入姓名搜索" readOnly="true" ]
            <select name="coach1.id" id="coach1_id" style="width:200px;display:none" onchange="updateName(this,'coach1_name')">
