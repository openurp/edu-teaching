...
[#if gradeState.confirmed]
  ...
  [@b.a href="grade!reportGa?clazzId="+clazz.id target="_blank"]打印[/@]
  [#--[#if !gradeState.published]
  [@b.a href="grade!reportGa?clazzId="+clazz.id target="_blank"]撤回x[/@]
  [/#if]
  --]
  [#if (gradeState.getState(GA).updatedAt)??]<span class="text-muted" style="font-size:0.8rem">最后录入:${gradeState.getState(GA).updatedAt?string("MM-dd HH:mm")}</span>[/#if]
[#else]
  [@b.a href="grade!info?clazzId="+clazz.id target="main"]查看[/@]
